    ...
    <section className="w-full overflow-hidden text-black py-10 relative">
      <div className="sticky mt-10 items-center justify-center text-center px-7 lg:px-44">
        ...
        >
          ...
          solutions tailored to your business needs. Our expertise spans web and
          mobile app development, cloud services, and IT consulting. Partner
          with us to transform your vision into reality with reliable and
          scalable solutions.
        </p>
      </div>
