...
const WhyVasundhara = () => {
  ...
  <img
    src="/images/6.png"
    className="hidden lg:block lg:max-w-full lg:pl-20 h-auto object-contain transform hover:scale-110 transition-transform duration-300"
    alt="Arrow Six"
  />
  <img
    src="/images/5.png"
  ...
  <img
    src="/images/4.png"
    className="hidden lg:block lg:max-w-full h-auto lg:pr-20 object-contain transform hover:scale-110 transition-transform duration-300"
    alt="Arrow Four"
  />
</div>
      ...
      <div className="text-center">
        ...
        {/* View All Button */}
        <div className="aos aos-init aos-animate mt-10" data-aos="fade-up">
          <a
            href="/aboutpage"
