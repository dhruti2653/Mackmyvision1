  ...
  return (
    <div className="container mx-auto px-4 pb-10">
      ...
      <div className="text-center mb-12">
        ...
        data-aos-delay="1000" className="flex justify-center items-center mb-4">
          <span className="text-4xl font-medium text-[#025add]">Contact Us</span>
        </div>
        <h2 data-aos="fade-up"
        data-aos-delay="1000" className="text-3xl lg:text-4xl font-bold">
      ...
      <div className="bg-gray-100 w-full shadow-md rounded-lg p-8  mx-auto">
        ...
        data-aos-delay="1000" className="flex justify-center">
            <button
              type="submit"
