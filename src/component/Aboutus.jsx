...
const ImageColumn = () => {
  const images = [
    ...
    { src: "../images/discover-3.jpg", alt: "Discover 3", size: "small", position: "bottom" },
  ];
      ...
      <div className="lg:w-1/2 flex justify-center items-center relative">
        ...
        {images.map((image, index) => {
          ...
          if (image.position === "right") {
            ...
            additionalClasses = "absolute lg:bottom-18 lg:translate-x-1/2 bottom-10 right-0 transform lg:right-auto z-20"; // Adjusted for responsive top position
          } else if (image.position === "bottom") {
            additionalClasses = "absolute lg:top-24 lg:-translate-x-1/2 top-40 left-0 transform lg:left-auto z-10"; // Adjusted for responsive bottom position
          }
